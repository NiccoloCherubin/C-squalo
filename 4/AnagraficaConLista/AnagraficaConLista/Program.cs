...
namespace AnagraficaConLista
{
    internal class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            int ultimo = -1;
            string[] opzioni = new string[] { "Inserimento", "Visualizza", "Cambia stato civile", "Calcolo età", "Rimozione", "Leggi log", "Tutti log", "Exit" };
            int scelta;
            do
            {
        ...
        static void VerifcaScelta(int scelta, List<Anagrafica> anagrafica, ref int ultimo)
        {
            ...
            switch (scelta)
            {
                ...
                case 1:
                    ...
                    {
                        anagrafica.ForEach(a=> { Console.WriteLine(a.ToString()); });
                ...
                case 3:
                    if (anagrafica.Count < 1)
                    {
                        ...
                        indice = anagrafica.FindIndex(a => a.nome == risposta);
                        if (indice != -1)
                        {
                ...
                case 4:
                    if (anagrafica.Count < 1)
                    {
                        ...
                        {
                            Console.WriteLine("Elemento non presente nell'anagrafe");
                        }
        ...
        static void Inserimento(List<Anagrafica> anagrafica, ref int ultimo)
        {
            string risposta;
        ...
        {     
            Anagrafica p1 = anagrafe[posizione];
            anagrafe.Remove(p1);
            p1.statocivile = (StatoCivile)Menu(Enum.GetNames(typeof(StatoCivile)), "STATO CIVILE", 0, 0, ConsoleColor.Magenta, ConsoleColor.Gray, ConsoleColor.Black);
            anagrafe.Insert(posizione, p1);
        }        
